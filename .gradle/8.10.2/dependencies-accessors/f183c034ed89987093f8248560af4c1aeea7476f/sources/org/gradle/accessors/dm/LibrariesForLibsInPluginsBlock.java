...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxCredentialsLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>credentials.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AudienceNetworkLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>audience.network.sdk</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final AudienceVersionAccessors vaccForAudienceVersionAccessors = new AudienceVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>psp</b> with value <b>4.4.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.audience</b>
         */
        public AudienceVersionAccessors getAudience() {
            return vaccForAudienceVersionAccessors;
        }
    ...
    public static class ActivityComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>activity.compose.version</b> with value <b>1.8.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AppVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>app.compat</b> with value <b>1.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AudienceVersionAccessors extends VersionFactory  {

        private final AudienceNetworkVersionAccessors vaccForAudienceNetworkVersionAccessors = new AudienceNetworkVersionAccessors(providers, config);
        public AudienceVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.audience.network</b>
         */
        public AudienceNetworkVersionAccessors getNetwork() {
            return vaccForAudienceNetworkVersionAccessors;
        }

    }

    public static class AudienceNetworkVersionAccessors extends VersionFactory  {

        public AudienceNetworkVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>audience.network.sdk</b> with value <b>6.19.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSdk() { return getVersion("audience.network.sdk"); }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.bom</b> with value <b>2025.02.00</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class CredentialsVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>credentials</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>credentials.version</b> with value <b>1.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("credentials.version"); }
    ...
    public static class IdentityVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>identity.services</b> with value <b>20.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getServices() { return getVersion("identity.services"); }
    ...
    public static class MaterialVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>material.icons</b> with value <b>1.7.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class NavVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>nav.hilt</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigation.compose</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PlayServicesVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>play.services</b> with value <b>24.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class SplashVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>splash.api</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
